...
public class TestJDBC_mysql  {
    ...
    static final String dbName  = "btp400_151a40";         // database name

    static final String userid =  "btp400_151a40";
    static final String password = "jAQ2357";
    ...
    public boolean testQueryAll() {
        ...
        try {
            // SQL statements: create a table and insert data
         	...
         	stat.executeUpdate( "CREATE TABLE survey (naics varchar(100), summary varchar(200), year2008 decimal(10,2), year2009 decimal(10,2),year2010 decimal(10,2),year2011 decimal(10,2),year2012 decimal(10,2) )" );

				    			 		// What if there's SQL syntax error? e.g. missing ')'
         	//publishers
        
			stat.executeUpdate( "INSERT INTO survey ( naics, summary, year2008,year2009,year2010,year2011,year2012) VALUES( 'Software publishers [51121]', 'Operating revenue (dollars x 1,000,000) (5)', 6226.50,5938.3,6250.40,6874.0,7549.0 )" );
			...
			stat.executeUpdate( "INSERT INTO survey ( naics, summary, year2008,year2009,year2010,year2011,year2012) VALUES( 'Software publishers [51121]', 'Salaries, wages and benefits (dollars x 1,000,000) (2)', 2832.60,2428.10,2723.6,2950.10,3192.10))" );
