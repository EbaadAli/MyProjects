...
class Hand:
    ...
    def __str__(self):
        return "You're holding {} cards".format(len(self.cards))
...
while user.still_has_cards() and comp.still_has_cards():
    total_rounds += 1
    print("Round {} Over".format(total_rounds))
...
print("Game Over in {} rounds".format(str(total_rounds)))
